...
public interface HttpServer extends Starter {
    static HttpServer createServer(HttpHandler handler) {
        return new KittyHttpServer(handler, null);
    }

    static HttpServer createServer(HttpHandler handler, String name) {
